export const en = {
  ...
  'email.connect.outlook': '+ Outlook / Hotmail',
  'email.connect.imap': '+ Other (iCloud, Yahoo…)',
  'email.imap.custom': 'Custom',
  'email.imap.password': 'App-specific password',
  'email.imap.host': 'IMAP server',
  'email.imap.hint': 'iCloud and Yahoo need an app-specific password — create one in your account security settings. We verify before saving; it is stored server-side only.',
