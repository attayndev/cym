export const en = {
  ...
  'email.body': 'Connected inboxes read message headers only — who and when, never contents. “Last talked” stays true on its own.',
  ...
  'deck.evaluate.title': 'Decide who belongs',
  ...
  'deck.updates.filledQuietly': '✓ Quietly filled in fresh details on {n} of your people today.',
  'deck.updates.title': 'Newer details found',
  'deck.updates.sub': 'Signals worth a look — nothing changes without your tap.',
  'deck.updates.apply': 'Update',
  'deck.updates.rhythmNote': 'You actually reach out about every {n} days.',
  ...
  'nudgec.role.headline': '{name} has news',
  'nudgec.role.reason': 'New chapter confirmed: {detail}.',
  'nudgec.role.reason.generic': 'They just stepped into a new role.',
  'nudgec.role.action': 'Send {name} a quick congrats — today beats next quarter.',
  ...
  'compose.context.label': 'Context for the note',
  'compose.context.hint': 'Anything to work in — a topic, a reason, a detail',
  'compose.generate': 'Draft this note',
  'compose.regen': 'Another take',
