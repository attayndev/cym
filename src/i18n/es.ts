...
export const es: Partial<Dict> = {
  ...
  'email.connect.imap': '+ Otra (iCloud, Yahoo…)',
  'email.imap.custom': 'Personalizado',
  'email.imap.password': 'Contraseña de aplicación',
  'email.imap.host': 'Servidor IMAP',
  'email.imap.hint': 'iCloud y Yahoo requieren una contraseña de aplicación — créala en la configuración de seguridad de tu cuenta. La verificamos antes de guardar; se almacena solo en el servidor.',
